...
This repository contains the worked sample app for the [Grails YourKit Profiling](https://grails.apache.org/guides/grails-yourkit-profiling/4/guide/index.html) guide on the Apache Grails site.
